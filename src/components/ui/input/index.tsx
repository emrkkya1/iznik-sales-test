...
const inputStyle = tva({
  base: 'min-h-11 w-full flex-row items-center rounded-xl border border-input bg-background shadow-xs overflow-hidden data-[focus=true]:outline-none data-[focus=true]:border-ring data-[focus=true]:web:ring-[3px] data-[focus=true]:web:ring-ring/40 data-[invalid=true]:border-destructive/40 data-[invalid=true]:web:ring-destructive/20 data-[disabled=true]:pointer-events-none data-[disabled=true]:cursor-not-allowed data-[disabled=true]:opacity-50 px-3 gap-2',
});
